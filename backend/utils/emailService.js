...
/**
 * Sends a welcome email containing user details and a secure password setup link.
 * Does not expose the raw password in any form.
 * 
    ...
    const mailOptions = {
      ...
      html: `
        <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; padding: 30px; border: 1px solid #e2e8f0; border-radius: 12px; background-color: #ffffff; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
          ...
          <p style="color: #475569; font-size: 15px; line-height: 1.5;">Your registration is complete. Welcome aboard! Below are your registered account details:</p>
          
          <div style="background-color: #f8fafc; padding: 20px; border-radius: 8px; border: 1px solid #f1f5f9; margin: 24px 0;">
            <h3 style="margin-top: 0; color: #1e293b; font-size: 16px; border-bottom: 1px solid #e2e8f0; padding-bottom: 8px;">Registration Details:</h3>
          ...
          <p style="color: #475569; font-size: 15px; line-height: 1.5;">To securely configure or setup your password, please use the following link (this link expires in 1 hour):</p>
          
          <div style="text-align: center; margin: 28px 0;">
            <a href="${setupPasswordUrl}" style="background-color: #4f46e5; color: #ffffff; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 14px; display: inline-block; box-shadow: 0 4px 6px -1px rgba(79, 70, 229, 0.2);">Secure Password Setup Link</a>
          </div>
          
          <p style="color: #475569; font-size: 14px; line-height: 1.5; margin-bottom: 10px;">Alternatively, you can login directly using your credentials here:</p>
          <div style="text-align: center; margin-bottom: 24px;">
            <a href="${loginUrl}" style="color: #4f46e5; text-decoration: underline; font-weight: 600; font-size: 14px;">Go to Login Page</a>
          </div>
          ...
          <div style="background-color: #fffbeb; border-left: 4px solid #f59e0b; padding: 12px 16px; border-radius: 4px; margin-bottom: 24px;">
            <p style="margin: 0; font-size: 13px; color: #b45309; line-height: 1.4;">
              <strong>Security reminder:</strong> We will never ask you for your password via email. Please keep your login details safe.
            </p>
          </div>
